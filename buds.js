...
var budsBattIndicator = GObject.registerClass(
  ...
  class BtGalaxyBudsBattIndicator extends PanelMenu.Button {
    constructor() {
      ...
      var hbox = new St.BoxLayout({
        style_class: "panel-status-menu-box bt-buds-batt-hbox",
      });
      this.icon = new St.Icon({
        style_class: "system-status-icon",
      });
      this.icon.gicon = Gio.icon_new_for_string(
        imports.misc.extensionUtils.getCurrentExtension().path +
          "/icons/buds.svg"
      );
